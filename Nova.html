...
.counter {
  border: 1px solid rgb(202, 135, 135);
  color: rgb(202, 135, 135);
  padding: 10px;
  border-radius: 15px;
  box-shadow: 0px 4px 10px #b96f6fd6;
  width: 90%; 
  max-width: 400px; 
  text-align: center;
  gap: 10px;
...
<div class="content">
  ...
  <div class="card-container">
    <div class="card">
      <div class="image">
        <img src="nails.png" alt="Nail Studio">
      </div>
      <div class="details">
        <div class="center">
          <h1>Nail Studios<br><span>Visit the best nail studios!</span></h1>
          <a href="bookingForm.html"><button class="button-ctg">Book now</button></a>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="image">
        <img src="hair.png" alt="Nail Studio">
      </div>
      <div class="details">
        <div class="center">
          <h1>Hair Salons<br><span>Visit the best hair salons!</span></h1>
          <a href="bookingForm.html"><button class="button-ctg">Book now</button></a>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      <div class="image">
        <img src="facial.png" alt="Nail Studio">
      </div>
      <div class="details">
        <div class="center">
        <h1> Skin care clinic<br><span>Visit the best skin care clinics!</span></h1>
        <a href="bookingForm.html"><button class="button-ctg">Book now</button></a>
        </div>
      </div>
    </div>
  ...
  <div class="counter-container">
    <div class="counter">Appointments booked: <span id="counter" >0</span></div>
  </div>
  ...
  <div class="carousel-container">
    <div class="carousel">
      <div class="card-review">
        <img src="profile1.jpg" alt="John Smith" class="profile-reviews">
        <p>"Booking my salon appointments has never been easier! The platform is user-friendly, and I love how I can see all available slots instantly. Plus, the reminders ensure I never miss an appointment. Highly recommended!"</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
        <span class="name">— Sophia R.</span>
         ...
         <div class="card-review">
        <img src="profile2.jpg" alt="John Smith" class="profile-reviews">
        <p>"Nova is a game-changer for beauty and wellness bookings. I found my favorite spa and discovered new ones I wouldn t have known about otherwise. The reviews and detailed profiles make choosing so simple."</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
        <span class="name">— Mark L.</span>
      </div>    <div class="card-review">
        <img src="profile3.jpg" alt="John Smith" class="profile-reviews">
        <p>"From haircuts to massages, Nova connects me with the best professionals in town. "</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
        <span class="name">— James P.</span>
      </div>
      <div class="card-review">
        <img src="profile4.jpg" alt="John Smith" class="profile-reviews">
        <p>"Booked a surprise spa day for my wife through Nova, and now she thinks Im a genius. Easiest way to earn husband points—10/10 would recommend!"</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
        <span class="name">- Will Smith</span>
      </div>
      <div class="card-review">
        <img src="profile5.jpg" alt="John Smith" class="profile-reviews">
        <p>"I ve tried other apps, but Nova stands out. No hidden fees, straightforward navigation.A must-have for self-care enthusiasts!"</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
      ...
      <div class="card-review">
        <img src="profile6.jpg" alt="John Smith" class="profile-reviews">
        <p>"Excellent customer service and a fantastic product. 5 stars!"</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
      ...
      <div class="card-review">
        <img src="profile1.jpg" alt="John Smith" class="profile-reviews">
        <p>"Booking my salon appointments has never been easier! The platform is user-friendly. Plus, the reminders ensure I never miss an appointment."</p>
        <div class="stars">
          <span>★★★★★</span>
        </div>
        <span class="name">— Mathew R.</span>
      </div> 
    </div>
  </div>
